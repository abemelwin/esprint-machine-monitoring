    ...
    <div className="w-full max-w-full p-3.5 px-4">
      ...
      <header className="flex items-center justify-between gap-3.5 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {pm.edit && <button className="inline-flex items-center gap-1.5 font-[550] cursor-pointer bg-[var(--accent)] text-white border border-[var(--accent)] hover:brightness-110 px-3.5 py-2 rounded-[9px] text-[13px]" onClick={() => { setView('machines'); /* trigger from MachinesView */ }}>＋ Add Machine</button>}
